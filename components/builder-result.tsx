...
import type { CurrencyCode } from "@/lib/currency-formater";

import { Button } from "@/components/ui/button";
import { useTranslation } from "@/context/i18n-store";
import { getCurrencySymbol } from "@/lib/currency-formater";
...
function BuilderResult({ recommendation, currency, handleReset }: { recommendation: PCBuildRecommendation; currency: string; handleReset: () => void }) {
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium">
              {recommendation.performanceRating}
              /10
            </span>
          </div>
        </div>
